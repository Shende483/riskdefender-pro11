...
export type SubbrokerPlanDocument = HydratedDocument<SubbrokerPlan>;
...
export const SubbrokerPlanDetailsSchema = SchemaFactory.createForClass(SubbrokerPlan);
