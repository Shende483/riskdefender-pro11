...
import { SubbrokerPlan, SubbrokerPlanDocument } from './subbroker-plan.schema';
import { Coupon, CouponDocument } from '../common-coupon-plan/coupon-schema';


@Injectable()
export class SubbrokerPlanService {
  constructor(
    @InjectModel(SubbrokerPlan.name) private planModel: Model<SubbrokerPlanDocument>,
